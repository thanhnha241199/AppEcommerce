...
//Package
import 'package:appecommerce/src/pages/home/widgets/content.dart';
import 'package:appecommerce/src/pages/home/widgets/header.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(
              left: _position != null
                  ? _position.dx > widget.size.width / 2
                      ? _dxMax
                      : 0
                  : _dxMax,
